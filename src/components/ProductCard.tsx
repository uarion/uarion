    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2 p-5">
        <div className="flex flex-wrap items-center gap-2">
          <span className="rounded-md bg-navy-800 px-2 py-0.5 text-xs font-semibold text-accent ring-1 ring-accent/25">
            검증점수 {product.verificationScore}
          </span>
          <span
            className={`rounded-md px-2 py-0.5 text-xs font-medium ring-1 ${statusStyles(product.certificationStatus)}`}
          >
